import {
  ...
  import MobileSideNav from "../Components/HamBurger";
  ...
  const Profile = () => {
    ...
    const { name, email, token, gender } = useSelector(
    ...
    const OrderArr = async () => {
     ...
     `${BASE_URL}/order/${userId}?page=${page}&limit=${1}`)
              ...
              {tab === 1 ? (
                ...
                <Stack divider={<StackDivider />} spacing="4" mt="3">
                  <Flex boxShadow="2xl" p="6" rounded="md" bg="white">
                    <Avatar size="xl" name={name} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqWLjey7DSXzaGjBv1GJYUD0XCXmd-H-eb-q_0AiTbvw&usqp=CAU&ec=48665698" />
                    <Box ml="3">
                      <Heading size="xs" textTransform="uppercase">
                        Name : {name}
                      </Heading>
